 ...
 *
 * Output contract: ONE short line, friend-tone, lowercase-leaning. Example:
 *   "I see Node.js / React / Aliyun + SWE @ Tesla; I’ll use that as profile evidence."
 *
 ...
 * @param lang  "zh" | "en" | "mixed". Retained for call-site compatibility;
...
export function formatCvSummaryForUser(
  ...
  // Role chunk: prefer "title @ company"; fall back to whichever single
  // field is present.
