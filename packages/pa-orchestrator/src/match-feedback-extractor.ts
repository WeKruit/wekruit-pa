...
export function buildFeedbackExtractPrompt(req: FeedbackExtractRequest): string {
  return [
    ...
    "      targetRoleFunction, negativeRoleFunction, industrySector, negativeIndustrySector, companySize, targetLocations, targetJobType, negativeJobType, careerStage, visaStatus, minSalary.",
    ...
    "      Example: \"I'm not looking for internships, full-time only\" → reasonCategory=wrong_job_type, tagDeltas={targetJobType:['full_time'], negativeJobType:['internship']}.",
    "Rules:",
