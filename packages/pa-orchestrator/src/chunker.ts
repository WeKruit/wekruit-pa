/**
 * @deprecated Sendblue native typing_indicator API replaced chunked simulation
 * for transport sends. This file remains only because output-normalizer still
 * uses planChunks for >600 char splits before the runtime-approved outbox.
 *
 * Used by `output-normalizer` for >600 char splits.
 *
