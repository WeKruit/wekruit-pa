...
export const WEKRUIT_YC_STARTUP_SOURCE = "yc_startup_school"

export type WekruitSignupSource =
  | typeof WEKRUIT_LAYOFF_SOURCE
  | typeof WEKRUIT_CANDIDATE_SOURCE
  | typeof WEKRUIT_YC_STARTUP_SOURCE

export function isWekruitSignupSource(value: unknown): value is WekruitSignupSource {
  return (
    value === WEKRUIT_LAYOFF_SOURCE ||
    value === WEKRUIT_CANDIDATE_SOURCE ||
    value === WEKRUIT_YC_STARTUP_SOURCE
  )
}
