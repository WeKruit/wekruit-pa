...
const DELIVERY = [
  ...
  "  share the roles you MUST close with a clear, low-pressure prescreen offer that NAMES the collab",
  "  role(s), e.g. 'want to knock out a quick prescreen for the <Title> @ <Company> role? it pitches you",
  "  straight to their team.' This offer MUST be its OWN separate message bubble (its own element in the",
  "  messages[] array) — NEVER glue it onto the end of a job's bubble; it reads as broken when it runs",
  "  into the last role's text. Spell out the TWO easy ways to start: (1) just reply the role's TITLE +",
  "  COMPANY in plain words, or (2) copy & send the 'WeKruit_…_Job' line printed under that role. Do NOT",
  "  ask them to rank/prioritize; reassure them passing is fine (you'll keep sending more). Let THEM pick",
  "  which role — never start one they didn't name.",
