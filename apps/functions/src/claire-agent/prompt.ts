  ...
  switch (mode) {
    ...
    default:
      return [
        ...
        "NOT roleplay starting it or ask for their email (the session handles that). Only the marked collab/",
        "partner roles get this pitch; share open-market roles normally.",
