...
import { buildConnectGmailUrl, YC_MATCH_DELIVERY_WHEN } from "@pa/pa-orchestrator"
  ...
  return [
    ...
    opts.ycEventIntake
      ? [
          ...
          `- When the tool says the intake is COMPLETE: close warmly — you've got what you need, their matches land on ${YC_MATCH_DELIVERY_WHEN} and you'll text them right here, nothing else for them to do. ONE message, no more questions.`,
