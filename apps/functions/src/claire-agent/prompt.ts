  ...
  return [
    ...
    opts.ycEventIntake
      ? [
          ...
          "- When the tool says the intake is COMPLETE: close warmly — you've got what you need, you'll text their founder matches ON JULY 25 AT 7PM PT, nothing else for them to do. ONE message, no more questions.",
