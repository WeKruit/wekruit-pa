    ...
    const parts: string[] = [
      ...
      ...(deps.ycEventIntake.offerLinkedin
        ? [
            ...
            "while that's cooking — what are you building right now? (tell me and I'll send you the attendee contact list)",
          ]
        : ["so — what are you building right now? (tell me and I'll send you the attendee contact list)"]),
      "reply STOP anytime to opt out.",
    ]
    const message = parts.join("\n\n")
