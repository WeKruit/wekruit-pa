...
test("PrescreenSessionsList shows pending review state", () => {
  ...
  assert.match(adminReviewSource, /Load all/)
  assert.match(adminReviewSource, /Include test sessions/)
  assert.match(adminReviewSource, /includeTest/)
  assert.match(adminReviewSource, /jobTitle/)
