...
test("Recruiter access gate uses SiteHeader instead of standalone back-link", () => {
  assert.doesNotMatch(source, /Back to WeKruit/, "Back to WeKruit link removed")
  assert.match(source, /import \{ SiteHeader \} from "\.\.\/components\/SiteHeader\.js"/)
