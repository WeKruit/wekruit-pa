...
See `README.md` for the canonical **Product Blueprint: Candidate Retention Marketplace**. See `.planning/MILESTONE-v2.0-candidate-retention-marketplace.md` for the sprint roadmap. See `CLAUDE.md` for the full v1.6 design lock, deploy authority, milestone state, roadmap, and matching v2.0 product lock.
